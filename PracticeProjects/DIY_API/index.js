...
app.post("/jokes", (req, res)=>{
  ...
  jokes.push(newJoke);
  console.log(jokes.slice(-1));    // gives a new array of last element. jokes[last]
  res.json(newJoke);
})
...
app.delete("jokes/:id", (req,res)=>{
  ...
  const searchIndex = jokes.findIndex((joke)=>joke.id===id);
  if(search>-1){
    jokes.splice(searchIndex, 1); //deleting that id, and 1 quantity is deleted.
    res.sendStatus(200);
  }else{
